...
\item
  \textbf{Inversión / Inventario (I):} Representado por las tenencias
  masivas de \emph{U.S. Treasuries} (\$215 billones en el caso de NBIM,
  \$1.21 billones en reservas de Japón). Esta deuda acumulada funciona
  como ``Inventario Inmovilizado'' con elevadas pérdidas latentes a
  medida que las tasas suben.
\item
  \textbf{Gasto de Operación (OE):} Los costos financieros y de
